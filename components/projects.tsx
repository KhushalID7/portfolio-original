...
const projects = [
  ...
  },
  {
    ...
    category: "Embedded",
    description: "IoT IR-sensor-based adaptive traffic light using Arduino and 74HC595 shift register.",
    ...
    outcomes: "Adaptive traffic intervals demo with scalable architecture for camera+CV pipeline.",
  },
  {
    id: 3,
    title: "Furnace Temperature Controller",
    category: "Embedded",
    description: "PID controller using Arduino & MAX6675; scaling to 1200°C furnace implementation.",
  ...
  },
  {
    ...
    category: "CV",
    description: "YOLO-based object detection demo on Streamlit; stores frames into PostgreSQL.",
    ...
    outcomes: "Working object-detection demo used during internship with real-time throughput optimization.",
  },
]
    ...
    <section id="projects" className="py-20 px-4 sm:px-6 lg:px-8 lg:ml-64">
      <div className="max-w-5xl mx-auto">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-3xl font-bold mb-8 text-primary">Interdisciplinary Projects & Research</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <AnimatePresence>
              {filtered.map((project, i) => (
                ...
                >
                  <div className="h-full p-6 bg-card border border-border rounded-lg hover:border-primary transition-all hover:shadow-lg hover:shadow-primary/20">
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      {project.tech.slice(0, 3).map((t) => (
                        <span key={t} className="px-2 py-1 bg-primary/20 text-primary text-xs rounded">
                          {t}
                        </span>
                      ))}
